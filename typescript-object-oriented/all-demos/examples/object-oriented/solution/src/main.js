...
var Main = /** @class */ (function () {
    ...
    Main.prototype.renderAccount = function (account) {
        ...
        var html = "\n                <h3>".concat(accountType, " Account</h3>\n                <image src=\"src/images/").concat(accountType.toLowerCase(), ".jpg\" height=\"150\">\n                <br /><br />\n                <span class=\"label\">Owner:</span> ").concat(account.title, "\n                <br />\n                <span class=\"label\">Balance:</span> $").concat(account.balance.toFixed(2), "\n                <br /><br />\n                $<input type=\"text\" id=\"depositWithdrawalAmount\">&nbsp;&nbsp;\n                <button onclick=\"main.depositWithDrawal(true)\">Deposit</button>&nbsp;\n                <button onclick=\"main.depositWithDrawal(false)\">Withdrawal</button>&nbsp;\n            ");
        this.renderer.render(html);
    };
